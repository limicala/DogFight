 ...
 * <p>
 * The <code>#bind methods perform string substitution and should be considered a
 * convenience and <em>not a full substitute replacement for MessageFormat#format
 * method calls.
 * </p>
 * <p>
 ...
 * the <code>#bind methods with text that does not map to an integer will result in an
 ...
 * </p>
 * <p>
 * Clients who wish to use the full substitution power of the <code>MessageFormat class should
 * call that class directly and not use these <code>#bind methods.
 * </p>
 * <p>
 * Clients may subclass this type.
 * </p>
 * <p>
 * Class copied from revision 1.15 in the org.eclipse.osgi bundle.
 * </p>
 *
